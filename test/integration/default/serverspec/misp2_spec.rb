...
##	trusty: fail
##	centos6: fail
describe command("cd #{misp_rootdir}/PyMISP && #{misp_virtualenv}/bin/poetry install -E fileobjects -E openioc -E virustotal -E docs -E pdfexport -E email && #{misp_virtualenv}/bin/poetry run python tests/test_mispevent.py"), :if => os[:release] != '14.04' && os[:release] != '6' do
